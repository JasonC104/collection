...
let accessToken = "";
const baseUrl = process.env.IGDB_API_V4_URL;

function getHeaders() {
    return {
        'Accept': 'application/json',
        'Client-ID': process.env.IGDB_API_V4_CLIENT_ID,
...
function authenticate() {
    const url = `${process.env.IGDB_API_V4_AUTH_URL}?client_id=${process.env.IGDB_API_V4_CLIENT_ID}&client_secret=${process.env.IGDB_API_V4_CLIENT_SECRET}&grant_type=client_credentials`;
...
module.exports = { authenticate, getItem, search, getAnticipated, getHighlyRated, getPopular, getRecentlyReleased };
